                ...
                <div class="row">
                  <div class="col-sm">
                        ...
                        <div class="container text-center lead  d-print-none mb-3 text-center text-dark">
                            <a href="#" class="text-secondary">Processo</a>
                        </div>
                  ...
                  <div class="col-sm">
                    ...
                    <div class="container text-center lead  d-print-none mb-3 text-center text-dark">
                        <a href="#" class="text-secondary">Horário</a>
                    </div>
                    <div class="d-none d-print-block"></div>
            ...
            <div class="container mt-4">
                <div class="row">
                  <div class="col-sm">
                        ...
                        <div class="container text-center lead  d-print-none mb-3 text-center text-dark">
                            <a href="#" class="text-secondary">Processos</a>
                        </div>
                        <div class="d-none d-print-block"></div>
                  ...
                  <div class="col-sm">
                    ...
                    <div class="container text-center lead  d-print-none mb-3 text-center text-dark">
                        <a href="#" class="text-secondary">Agenda</a>
                    </div>
                    <div class="d-none d-print-block"></div>
